...
assert(!/TaskRuntime|supabase|password|Realtime/i.test(expenseSource),'project expenses must stay independent from task runtime, Supabase, password and Realtime');
...
win.S={projekte:[{id:'p1',name:'Bad',material:[{id:'m1',bezeichnung:'Fliesen'}],ausgaben:[{id:'e1',datum:'2026-08-30',kategorie:'Material',lieferant:'Bauhaus',betrag:123.45,inKalkulation:true,belegDataURL:'data:image/jpeg;base64,AAA'}]}]};
